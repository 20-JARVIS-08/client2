...
function seedPosts() {
    return [
        ...
        },
        {
            ...
            content: 'بهنام خسروی، نویسنده فیلم‌نامه «ماندالا»، پیش از ورود جدی‌تر به فیلمسازی کوتاه، تجربه نویسندگی رمان را نیز در کارنامه خود دارد؛ از جمله رمان «سرزمین غریبه» که نگاه داستانی او را شکل داده است.\n\nاو در فیلم‌نامه «ماندالا» از همان حس و نگاه روایی حاضر در آثار داستانی‌اش بهره گرفته و توانسته با ساختاری فشرده و نمادین، مضمون هویت و فراموشی را در قالب یک فیلم کوتاه روایت کند.\n\n[در صورت تمایل، جزئیات بیشتری درباره روند نگارش فیلم‌نامه «ماندالا» به این مطلب اضافه شود.]',
            date: '1404-01-10',
            color: 4,
